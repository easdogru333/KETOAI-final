      ...
      <div className="container mx-auto px-4">
        <div className="bg-white rounded-[40px] border border-gray-200 shadow-lg p-12 text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-4">
            <button
              disabled
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-gray-100 via-white to-gray-100 text-black border border-gray-900 shadow-lg hover:shadow-xl transform hover:scale-[1.03] transition-all duration-500 ease-out"
            >
