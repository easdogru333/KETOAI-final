  ...
  return (
    <section id="how-it-works" className="py-8 sm:py-20">
      <div className="container mx-auto px-3 sm:px-4">
        {/* Title */}
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-16 font-outfit tracking-tight">
          How KetoAI Works
        </h2>
        <div className="grid md:grid-cols-2 gap-6 sm:gap-12 items-center">
          ...
          <div className="flex flex-col justify-between space-y-8 md:space-y-0 h-full py-2 sm:py-4">
            ...
            <div className="flex gap-4 sm:gap-6">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 font-outfit">Quick & Easy Tracking</h3>
            ...
            <div className="flex gap-4 sm:gap-6">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 font-outfit">Instant AI Analysis</h3>
                <p className="text-gray-600 text-base sm:text-lg">
            ...
            <div className="flex gap-4 sm:gap-6">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 font-outfit">Personalized Insights</h3>
                <p className="text-gray-600 text-base sm:text-lg">
