  ...
  return (
    <section id="how-it-works" className="py-12 sm:py-20">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-4xl font-bold text-center pt-8 sm:pt-12 mb-6 sm:mb-12 font-outfit tracking-tight">
          How KetoAI Works
        </h2>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between py-4">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Simply take a photo of your meal or upload an image.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Our advanced AI technology instantly identifies foods, estimates portions, and calculates your macronutrients with high accuracy.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Get personalized recommendations and insights based on your specific dietary requirements and keto goals.</p>
              </div>
            </div>
          </div>
        </div>
