  ...
  return (
    <section className="pt-16 pb-12 sm:pt-20 sm:pb-16">
      <div className="max-w-[1000px] mx-auto px-3 sm:px-4 text-center">
        <h1 className="text-3xl sm:text-5xl md:text-[65px] font-bold mb-4 sm:mb-6 font-outfit tracking-tighter leading-[1.1] text-black">
          Track your Keto diet simply
        </h1>
        <p className="text-base sm:text-xl text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto font-inter leading-relaxed">
          Take a photo of your meal and let AI calculate your keto macros.
          <br className="hidden sm:block" />
          Precise, fast and easy to use.
        </p>
        <div className="flex items-center justify-center gap-4 sm:gap-6">
          <div className="bg-gradient-to-r from-red-50 to-red-100 px-4 sm:px-6 py-1.5 sm:py-2 rounded-full">
          ...
          <div className="bg-black rounded-full px-4 sm:px-6 py-2 sm:py-3 hover:bg-gray-900 transition-colors transform hover:scale-105 duration-200">
            <img 
